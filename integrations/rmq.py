            ...
            if self.reply_to:
                ...
                try:
                    self._channel.basic_publish(
                        exchange=self.reply_to, routing_key="", body=out_body, properties=out_props
                    )
                except Exception as e:
...
class RMQConsumer:
    ...
    def __init__(self,
        ...
        If 'reply_to' is provided messaged will be published to given exchange/queue name
